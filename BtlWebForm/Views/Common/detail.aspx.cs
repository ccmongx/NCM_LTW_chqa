...
namespace BtlWebForm.Views.Common
{
    public partial class detail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (product != null)
            {
                if (url.Contains("quan-ao"))
                {
                    url_page.Attributes.Add("href", "/quan-ao");
                    name_page.InnerText = "Quần áo";
                    slug_.Attributes.Add("href", "/quan-ao/" + product.Slug);
                }
                else
                {
                    url_page.Attributes.Add("href", "/vay-nu");
                    name_page.InnerText = "Váy nữ";
                    slug_.Attributes.Add("href", "/vay-nu/" + product.Slug);
                }
