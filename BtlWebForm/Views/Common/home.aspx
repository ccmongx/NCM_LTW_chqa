...
<asp:Content ID="Content2" ContentPlaceHolderID="CommonBody" runat="server">
    <div class="container">
        <div class="banner">
            <img src="/static/img/banner/slide_img_1.jpg" />
        </div>

        <!-- Danh muc may tinh -->
        <div class="nav flex space_">
            <div class="nav_title">
                <a href="/quan-ao" class="edit_tit">Quần áo</a>
            </div>
            <div class="nav_list flex">
                <ul class="__ul flex">
                    <li><a href="/">Trang chủ</a></li>
                    <li><a href="/quan-ao">Sản phẩm</a></li>
        ...
        <div class="nav flex space_ margintop" style="background-color: #dd2b2b;">
            <div class="nav_title">
                <a href="/vay-nu" class="edit_tit">Váy nữ</a>
            </div>
            <div class="nav_list flex">
                <ul class="__ul flex">
                    <li><a href="/">Trang chủ</a></li>
                    <li><a href="/vay-nu">Sản phẩm</a></li>
                    <li><a href="/blog">Blog</a></li>
                    <li><a href="/about">Giới thiệu</a></li>
                    <li><a href="/contact">Liên hệ</a></li>
                </ul>
